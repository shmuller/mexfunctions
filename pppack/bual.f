      subroutine bual ( t, bcoef, n, k, d, p, x, y )
...
c
      integer k,d,p,n,   i,ilo,imk,j,jc,jcmin,jcmax,jj,dd,pp
     *                  ,kmax,kmj,km1,mflag,nmi
      parameter (kmax = 20)
      real bcoef(d,n,p),t(n+k),x,y(d,p),   aj(kmax),dl(kmax),dr(kmax)
c
