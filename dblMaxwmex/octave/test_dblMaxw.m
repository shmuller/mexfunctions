...
I2__ = dblMaxwmex('vrel',1,vt,v0,ut,u0,int32([3,3]),'MM')

v3 = linspace(-5,5,1000);

tic
I3 = dblMaxwmex('ion',1,vt,v0,ut,u0,int32([2,3]),'MM',v3);
toc

fun = @(x) dblMaxwmex('one',1,vt,v0,ut,u0,int32([2,3]),'MM',x);
...
tic
I13_ion = dblMaxwmex('ion',1,vn,z,ve,z,int32([1,3]),'MM',v1,v2);
toc
...
tic
I13_CX = dblMaxwmex('CX',1,vn,z,vi,z,int32([1,3]),'MM',v1,v2);
toc
...
tic
I22_ion = dblMaxwmex('ion',1,vn,z,ve,z,int32([2,2]),'OO',v3,u3);
toc
...
tic
I22_CX = dblMaxwmex('CX',1,vn,z,vi,z,int32([2,2]),'OO',v3,u3);
toc
...
tic
I = dblMaxwmex('vrel',1,vn,z,vi,z,int32([1,1]),'MM',v1,v2,u1,u2);
toc
